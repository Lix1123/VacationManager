...
namespace VacationManager.Migrations
{
    ...
    [Migration("20250316082301_AddLeaveRequestsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "4d1343e8-06af-4a41-9d44-cbda3a770602",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "97e3eb47-7185-4b9a-b849-7eb9a1b66cc3",
                            Name = "TeamLead",
                            NormalizedName = "TEAMLEAD"
                        },
                        new
                        {
                            Id = "51fa6aa9-274c-4cb7-9354-bcce1943b4a3",
                            Name = "Developer",
            ...
            modelBuilder.Entity("VacationManager.Models.LeaveRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("VacationManager.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VacationManager.Models.LeaveRequest", b =>
                {
                    b.HasOne("VacationManager.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("VacationManager.Models.Team", b =>
                {
                    ...
                    b.HasOne("VacationManager.Models.User", "TeamLead")
                        .WithMany()
